...
long idx = contentData.getB1_idx();
%>
<!DOCTYPE html>
<html lang="ko">
<head>
        ...
        <div class="col-xl-10 offset-xl-1 col-lg-8 offset-lg-2 col-12 mt-3 mb-4">
            <form action="noticeCUD.get" method="post">
                <div class="form-group">
                    <input type="text" class="form-control" id="subject" name="subject" value="<%= contentData.getB1_subject()%>">
                </div>
                
                <div class="form-group">
                    <textarea class="form-control" rows="10" id="content" name="content" style="resize:none"><%= contentData.getB1_content() %></textarea>
                </div>
